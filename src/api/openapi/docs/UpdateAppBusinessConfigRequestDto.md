...
```typescript
import type { UpdateAppBusinessConfigRequestDto } from ''
...
} satisfies UpdateAppBusinessConfigRequestDto
...
const exampleParsed = JSON.parse(exampleJSON) as UpdateAppBusinessConfigRequestDto
