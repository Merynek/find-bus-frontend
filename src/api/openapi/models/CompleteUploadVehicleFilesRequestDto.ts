 ...
 * 
 * @export
 * @interface CompleteUploadVehicleFilesRequestDto
 */
export interface CompleteUploadVehicleFilesRequestDto {
    /**
     * 
     * @type {number}
     * @memberof CompleteUploadVehicleFilesRequestDto
     */
    vehicleId: number;
    /**
     * 
...
/**
 * Check if a given object implements the CompleteUploadVehicleFilesRequestDto interface.
 */
export function instanceOfCompleteUploadVehicleFilesRequestDto(value: object): value is CompleteUploadVehicleFilesRequestDto {
...
export function CompleteUploadVehicleFilesRequestDtoFromJSON(json: any): CompleteUploadVehicleFilesRequestDto {
    return CompleteUploadVehicleFilesRequestDtoFromJSONTyped(json, false);
}

export function CompleteUploadVehicleFilesRequestDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompleteUploadVehicleFilesRequestDto {
    if (json == null) {
        return json;
    }
    return {
...
export function CompleteUploadVehicleFilesRequestDtoToJSON(json: any): CompleteUploadVehicleFilesRequestDto {
    return CompleteUploadVehicleFilesRequestDtoToJSONTyped(json, false);
}

export function CompleteUploadVehicleFilesRequestDtoToJSONTyped(value?: CompleteUploadVehicleFilesRequestDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
