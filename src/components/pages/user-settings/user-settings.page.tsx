    ...
    return <div className={styles.layout}>
        <form action={action}>
            <div>
                ...
                <input id={FormDataEnum.name} name={FormDataEnum.name} type={"text"} placeholder="Name" defaultValue={state?.data?.name || settings.name}/>
            </div>
            {state?.errors?.name && <p>{state.errors.name}</p>}
            <div>
                <label htmlFor={FormDataEnum.surname}>Surname</label>
                <input id={FormDataEnum.surname} name={FormDataEnum.surname} type={"text"} placeholder="Surname" defaultValue={state?.data?.surname || settings.surname} />
            </div>
            {state?.errors?.surname && <p>{state.errors.surname}</p>}
            <div>
                <label htmlFor={FormDataEnum.phoneNumber}>PhoneNumber</label>
                <input id={FormDataEnum.phoneNumber} name={FormDataEnum.phoneNumber} type={"tel"} defaultValue={state?.data?.phoneNumber || settings.phoneNumber}
            ...
            <div>
                ...
                <input id={FormDataEnum.ico} name={FormDataEnum.ico} type={"text"} placeholder="Ico" defaultValue={state?.data?.ico || settings.ico}/>
            </div>
            {state?.errors?.ico && <p>{state.errors.ico}</p>}

            <div>
                <label htmlFor={FormDataEnum.dic}>dic</label>
                <input id={FormDataEnum.dic} name={FormDataEnum.dic} type={"text"} placeholder="Dic" defaultValue={state?.data?.dic || settings.dic}/>
            </div>
            ...
            {user?.role === UserRole.TRANSPORTER && <>
                ...
                <LayoutFlexColumn>
                    <div>
                        ...
                        <input id={FormDataEnum.iban} name={FormDataEnum.iban} type={"text"} placeholder="Iban" defaultValue={state?.data?.iban || settings.transferInfo.iban}/>
                    </div>
                    {state?.errors?.iban && <p>{state.errors.iban}</p>}
                    <div>
                        <label htmlFor={FormDataEnum.swift}>swift</label>
                        <input id={FormDataEnum.swift} name={FormDataEnum.swift} type={"text"} placeholder="swift" defaultValue={state?.data?.swift || settings.transferInfo.swift}/>
                    </div>
